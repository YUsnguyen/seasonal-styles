    ...
    $('.seasons a').click(function(e){//find all a tags inside class of seasons
        ...
        switch(season){
            ...
            case "Summer":{
                ...
                $("header h3").text("Beat the heat during Summer with some new light clothes!");
            };
            break; 
            ...
            case "Winter":{
                ...
                $("header h3").text("The holiday season is almost here for Winter! Time to get Christmas shopping ready!");
            };
            break; 
